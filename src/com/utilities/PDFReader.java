...
public class PDFReader {
	...
	public void ReadPDFFile() throws Exception {
		...
		File file = new File("C:\\Users\\Admin\\Downloads\\certificate.pdf");
		...
		pdfTextStripper.setEndPage(1); // comment this line if you want to read the entire document
		String docText = pdfTextStripper.getText(pdfDocument);

		System.out.println(docText);

		Assert.assertTrue(docText.contains("Maharashtra"));
